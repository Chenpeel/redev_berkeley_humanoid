...
class BalanceTaskConfigTestCase(unittest.TestCase):
    def test_humanoid_recovery_enables_interval_push_event(self) -> None:
        events_cfg = humanoid_recovery_env_cfg.EventsCfg()
    ...
    def test_recovery_rewards_add_in_place_penalties(self) -> None:
        humanoid_rewards = humanoid_recovery_env_cfg.RewardsCfg()
        biped_rewards = biped_recovery_env_cfg.RewardsCfg()
