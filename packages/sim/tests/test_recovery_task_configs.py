...
@unittest.skipIf(
    register_tasks is None,
    f"isaaclab-dependent recovery registry import unavailable: {TASK_IMPORT_ERROR}",
)
class RecoveryTaskConfigContractTestCase(unittest.TestCase):
    def test_optional_recovery_task_ids_follow_module_availability(self) -> None:
    ...
    def test_register_tasks_only_registers_available_recovery_tasks(self) -> None:
