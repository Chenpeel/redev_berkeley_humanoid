...
_MODULE_EXPORTS = {
    ...
    "ExperimentPreset": ("berkeley_humanoid_lite.training.experiment_workflow", "ExperimentPreset"),
    "EXPERIMENT_PRESETS": ("berkeley_humanoid_lite.training.experiment_workflow", "EXPERIMENT_PRESETS"),
    "get_experiment_preset": ("berkeley_humanoid_lite.training.experiment_workflow", "get_experiment_preset"),
    "build_run_name": ("berkeley_humanoid_lite.training.experiment_workflow", "build_run_name"),
    "build_run_pattern": ("berkeley_humanoid_lite.training.experiment_workflow", "build_run_pattern"),
    "build_train_command": ("berkeley_humanoid_lite.training.experiment_workflow", "build_train_command"),
    "build_play_command": ("berkeley_humanoid_lite.training.experiment_workflow", "build_play_command"),
    "render_command": ("berkeley_humanoid_lite.training.experiment_workflow", "render_command"),
    "resolve_run_directory": ("berkeley_humanoid_lite.training.experiment_workflow", "resolve_run_directory"),
    "stage_checkpoint_for_resume": (
        "berkeley_humanoid_lite.training.experiment_workflow",
        "stage_checkpoint_for_resume",
    ),
    "archive_exported_policy": ("berkeley_humanoid_lite.training.experiment_workflow", "archive_exported_policy"),
