...
from berkeley_humanoid_lite_lowlevel.robot.gripper import SerialGripper
...
class Bimanual:
    def __init__(
        ...
        *,
        ...
        self.gripper = SerialGripper(port=gripper_port, baudrate=gripper_baudrate)
    ...
    def update_joints(self):
        ...
        self.gripper.write_targets(self.gripper_left_target, self.gripper_right_target)
